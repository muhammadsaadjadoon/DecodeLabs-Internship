<div align="center">
  ...
  **A premium full-stack code intelligence workspace for evidence-grounded defect detection, validated corrections, clean-code verification, and structured line-by-line explanation.**
...
<p align="center">
  <img src="./docs/screenshots/01-dark-workspace.png" alt="CodeFix AI premium dark workspace" width="100%" />
</p>
...
### Premium Dark and Light Workspaces

<table>
  <tr>
    <td width="50%"><img src="./docs/screenshots/01-dark-workspace.png" alt="CodeFix AI dark workspace" width="100%" /></td>
    <td width="50%"><img src="./docs/screenshots/03-light-workspace.png" alt="CodeFix AI light workspace" width="100%" /></td>
  </tr>
  <tr>
    <td align="center"><strong>Dark workspace</strong></td>
    <td align="center"><strong>Light workspace</strong></td>
  </tr>
</table>

### Review Conversation

Submitted source and AI output are presented as a structured engineering conversation with filename, language, line count, developer identity, review state, and a tabbed result workspace.

<p align="center">
  <img src="./docs/screenshots/04-review-conversation.png" alt="Submitted source and AI review conversation" width="100%" />
</p>
...
<table>
  <tr>
    <td width="50%"><img src="./docs/screenshots/05-overview-corrected-output.png" alt="Overview with findings and corrected output" width="100%" /></td>
    <td width="50%"><img src="./docs/screenshots/06-evidence-grounded-finding.png" alt="Evidence-grounded finding detail" width="100%" /></td>
  </tr>
  <tr>
    <td align="center"><strong>Overview and production-ready code</strong></td>
    <td align="center"><strong>Evidence-grounded defect detail</strong></td>
  </tr>
</table>

### Corrected Code and Line-by-Line Walkthrough

<table>
  <tr>
    <td width="50%"><img src="./docs/screenshots/07-corrected-code.png" alt="Complete corrected source code" width="100%" /></td>
    <td width="50%"><img src="./docs/screenshots/08-line-by-line-explanation.png" alt="Line-by-line code explanation" width="100%" /></td>
  </tr>
  <tr>
    <td align="center"><strong>Complete corrected source</strong></td>
    <td align="center"><strong>Structured code walkthrough</strong></td>
  </tr>
</table>

### Clean-Code Verification

When no confirmed defect exists, CodeFix AI returns a clear verified state and preserves the submitted source unchanged.

<table>
  <tr>
    <td width="50%"><img src="./docs/screenshots/09-clean-code-verification.png" alt="Clean code verification in light theme" width="100%" /></td>
    <td width="50%"><img src="./docs/screenshots/11-dark-clean-review.png" alt="Clean code verification in dark theme" width="100%" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="62%"><img src="./docs/screenshots/10-language-auto-detection.png" alt="Automatic language detection and filename update" width="100%" /></td>
    <td width="38%"><img src="./docs/screenshots/12-premium-language-selector.png" alt="Premium programming-language selector" width="100%" /></td>
  </tr>
  <tr>
    <td align="center"><strong>Content-first automatic detection</strong></td>
    <td align="center"><strong>Premium language selector</strong></td>
  </tr>
</table>

### Workspace Preferences and File Upload

<table>
  <tr>
    <td width="50%"><img src="./docs/screenshots/13-workspace-preferences.png" alt="CodeFix AI workspace preferences" width="100%" /></td>
    <td width="50%"><img src="./docs/screenshots/14-file-upload.png" alt="Drag-and-drop source file upload" width="100%" /></td>
  </tr>
  <tr>
    <td align="center"><strong>Profile, appearance, and review intelligence</strong></td>
    <td align="center"><strong>Drag-and-drop source upload</strong></td>
  </tr>
</table>
...
<p align="center">
  <img src="./docs/screenshots/02-settings-dark.png" alt="Full CodeFix AI settings panel" width="58%" />
</p>
